      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold text-white">JureLex_AI</h1>
          </div>
    ...
    <div className="text-center">
      <div className="mb-16">
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
           <span className="text-blue-400">JureLex_AI</span>
        </h1>
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
           “Your smart companion for decoding law, analyzing cases, and generating legal documents instantly.”
          “From statutes to strategy — AI-powered clarity for every legal question.”
        </p>
      ...
      <div className="bg-gray-800 rounded-lg p-8 text-left">
        <h2 className="text-2xl font-bold text-white mb-6 text-center">Why Choose JureLex_AI?</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <TrendingUp className="w-5 h-5 text-green-400 mt-1" />
              <div>
                <h3 className="font-semibold text-white">Cognitive Legal Search</h3>
                <p className="text-gray-300 text-sm">Advanced nlp, AI that understands legal reasoning, not just keywords</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <Scale className="w-5 h-5 text-blue-400 mt-1" />
              <div>
                <h3 className="font-semibold text-white">Knowledge Graph of Law</h3>
                <p className="text-gray-300 text-sm">Linking statutes, precedents, and principles seamlessly</p>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-white">Document Generation-Automated Legal Drafting</h3>
                <p className="text-gray-300 text-sm">Generate accurate, structured legal documents instantly</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <Award className="w-5 h-5 text-yellow-400 mt-1" />
              <div>
                <h3 className="font-semibold text-white">Built for Legal Precision</h3>
                <p className="text-gray-300 text-sm">Empowering professionals with intelligent, reliable insights</p>
              </div>
            </div>
          </div>
        </div>
  ...
  const handleSubmit = async (query) => {
    ...
    try {
      ...
      if (data.answers) {
        ...
        const firstAnswer = data.answers[firstModel];
        const citations = extractCitations(firstAnswer);
        ...
        onAddMessage(query, firstAnswer, 'IPC');
      } else {
        setMessages(prev => [
          ...prev,
          {
